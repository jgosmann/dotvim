...
function rainbow_parenthsis#Activate()
    highlight default level1c  ctermbg=LightGray ctermfg=brown        guibg=background   guifg=RoyalBlue3
    highlight default level2c  ctermbg=LightGray ctermfg=Darkblue     guibg=background   guifg=SeaGreen3
    highlight default level3c  ctermbg=LightGray ctermfg=darkgray     guibg=background   guifg=DarkOrchid3
    highlight default level4c  ctermbg=LightGray ctermfg=darkgreen    guibg=background   guifg=firebrick3
    highlight default level5c  ctermbg=LightGray ctermfg=darkcyan     guibg=background guifg=RoyalBlue3
    highlight default level6c  ctermbg=LightGray ctermfg=darkred      guibg=background guifg=SeaGreen3
    highlight default level7c  ctermbg=LightGray ctermfg=darkmagenta  guibg=background guifg=DarkOrchid3
    highlight default level8c  ctermbg=LightGray ctermfg=brown        guibg=background guifg=firebrick3
    highlight default level9c  ctermbg=LightGray ctermfg=gray         guibg=background guifg=RoyalBlue3
    highlight default level10c ctermbg=LightGray ctermfg=black        guibg=background guifg=SeaGreen3
    highlight default level11c ctermbg=LightGray ctermfg=darkmagenta  guibg=background guifg=DarkOrchid3
    highlight default level12c ctermbg=LightGray ctermfg=Darkblue     guibg=background guifg=firebrick3
    highlight default level13c ctermbg=LightGray ctermfg=darkgreen    guibg=background    guifg=RoyalBlue3
    highlight default level14c ctermbg=LightGray ctermfg=darkcyan     guibg=background    guifg=SeaGreen3
    highlight default level15c ctermbg=LightGray ctermfg=darkred      guibg=background    guifg=DarkOrchid3
    highlight default level16c ctermbg=LightGray ctermfg=red          guibg=background    guifg=firebrick3
    let g:rainbow_parenthesis#active = 1
endfunction
...
function rainbow_parenthsis#Clear()
    ...
    endwhile
    let g:rainbow_parenthesis#active = 0
endfunction

function rainbow_parenthsis#Toggle ()
    if ! exists('g:rainbow_parenthesis#active')
        call rainbow_parenthsis#LoadRound ()
    endif
    if g:rainbow_parenthesis#active != 0
